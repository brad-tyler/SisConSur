<div>
    <div class="flex justify-between border-b-4 border-gray-500 mx-8 mt-5">
    ...
    <div class="p-6 lg:p-8 bg-white border-b border-gray-200">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 m-2">
            <x-datos-circular-columns :adultos="$adultos" :adolecentes="$adolecentes" :gestantes="$gestantes" :ninos="$ninos"
                :tamizajeLabels="$tamizajeLabels" :estado1Counts="$estado1Counts" :estado2Counts="$estado2Counts" />
        </div>
    </div>
</div>
